...
public class FileDrop
{
    ...
    /**
     * Constructs a {@link ru.lanit.dibr.utils.utils.FileDrop} with a default light-blue border
     ...
     * @since 1.0
     */
    public static boolean remove( PrintStream out, java.awt.Component c, boolean recursive )
...
/* ********  I N N E R   C L A S S  ******** */    
    ...
    public static class Event extends java.util.EventObject {
        ...
        /**
         * Constructs an {@link ru.lanit.dibr.utils.utils.FileDrop.Event} with the array
         * of files that were dropped and the
         * {@link ru.lanit.dibr.utils.utils.FileDrop} that initiated the event.
         *
...
/* ********  I N N E R   C L A S S  ******** */
     ...
     * moving data out of a list, say, you can use the {@link ru.lanit.dibr.utils.utils.FileDrop.TransferableObject.Fetcher}
     ...
     * {@link ru.lanit.dibr.utils.utils.FileDrop.TransferableObject} has the representation class
    ...
    public static class TransferableObject implements java.awt.datatransfer.Transferable
    {
        ...
        /**
         * Creates a new {@link ru.lanit.dibr.utils.utils.FileDrop.TransferableObject} that wraps <var>data</var>.
        ...
        /**
         * Creates a new {@link ru.lanit.dibr.utils.utils.FileDrop.TransferableObject} that will return the
         * object that is returned by <var>fetcher</var>.
         * No custom data flavor is set other than the default
         * {@link #DATA_FLAVOR}.
         *
         * @see ru.lanit.dibr.utils.utils.FileDrop.TransferableObject.Fetcher
         * @param fetcher The {@link ru.lanit.dibr.utils.utils.FileDrop.TransferableObject.Fetcher} that will return the data object
         * @since 1.1
         */
         ...
         * with the encapsulated object or <tt>null</tt> if the {@link ru.lanit.dibr.utils.utils.FileDrop.TransferableObject.Fetcher}
    ...
    /* ********  T R A N S F E R A B L E   M E T H O D S  ******** */    
         ...
         * {@link ru.lanit.dibr.utils.utils.FileDrop.TransferableObject}, and third the
        ...
        /**
         * Returns the data encapsulated in this {@link ru.lanit.dibr.utils.utils.FileDrop.TransferableObject}.
         * If the {@link ru.lanit.dibr.utils.utils.FileDrop.TransferableObject.Fetcher} constructor was used, then this is when
         * the {@link ru.lanit.dibr.utils.utils.FileDrop.TransferableObject.Fetcher#getObject getObject()} method will be called.
         * If the requested data flavor is not supported, then the
         * {@link ru.lanit.dibr.utils.utils.FileDrop.TransferableObject.Fetcher#getObject getObject()} method will not be called.
         *
    ...
    /* ********  I N N E R   I N T E R F A C E   F E T C H E R  ******** */    
        ...
        /**
         * Instead of passing your data directly to the {@link ru.lanit.dibr.utils.utils.FileDrop.TransferableObject}
         ...
         * on the {@link ru.lanit.dibr.utils.utils.FileDrop.TransferableObject}, the {@link ru.lanit.dibr.utils.utils.FileDrop.TransferableObject.Fetcher}'s
        ...
        public static interface Fetcher
        {
             ...
             * {@link ru.lanit.dibr.utils.utils.FileDrop.TransferableObject}.
             *
